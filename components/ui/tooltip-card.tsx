            ...
            <AnimatePresence>
                {isVisible && (
                    <motion.div
                        ...
                        className="pointer-events-none absolute z-50 min-w-[15rem] overflow-hidden rounded-md border border-transparent shadow-sm ring-1 shadow-black/5 ring-black/5 dark:bg-neutral-900 dark:shadow-white/10 dark:ring-white/5 text-white"
                        style={{
                            top: position.y,
                            left: position.x,
                        }}
                    >
                        <div
                            ref={contentRef}
                            className="p-2 text-sm md:p-4 text-white bg-[#242425]"
                        >
                            {content}
                        </div>
                    </motion.div>
