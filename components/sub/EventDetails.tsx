...
const EventDetails: React.FC<EventDetailsProps> = ({ venue, date, time, href, href2 }) => {
  return (
    <div className="rounded-md px-[20px] lg:p-0 mb-5">
      ...
      <div className="flex flex-col justify-center items-center mt-4">
        ...
        <div className="flex flex-row justify-center w-full gap-4">
          ...
          <Link href={href2 ? href2 : "/"} target='_blank' className="w-auto transform transition-transform hover:z-10 hover:scale-105 hover:rounded-r-lg">
