...
const committees = [
  ...
  { id: 4, name: "Fun Activities", imageSrc: "/images/final website photos/fun activites.jpeg", head: "Prosnita", coHead: "Thanvi" },
  { id: 5, name: "Decor", imageSrc: "/images/final website photos/decor.jpeg", head: "Anjali", coHead: "Humera" },
  { id: 6, name: "Pre-Infinitus", imageSrc: "/images/final website photos/Pre-infinitus.jpeg", head: "Sathwik K", coHead: "Dhanush G" },
  { id: 7, name: "Business Relations", imageSrc: "/images/final website photos/Business Relations.jpeg", head: "Amruth", coHead: "Jathin" },
  { id: 8, name: "Publicity", imageSrc: "/images/final website photos/Publicity Committee.jpeg", head: "Mohnish", coHead: "Raghavi" },
  { id: 9, name: "Outreach", imageSrc: "/images/final website photos/outreach.jpeg", head: "Nameer", coHead: "Hasitha" },
  { id: 10, name: "Registrations", imageSrc: "/images/final website photos/registrations.jpeg", head: "Jashwanth", coHead: "Manish" },
  { id: 11, name: "Hospitality", imageSrc: "/images/final website photos/Hospitality.jpeg", head: "Wasim Raja", coHead: "Nirmal" },
  { id: 12, name: "Post Production", imageSrc: "/images/final website photos/Post Production.jpeg", head: "Praharsha", coHead: "Abhinay" },
  { id: 13, name: "Design", imageSrc: "/images/final website photos/Design.jpeg", head: "Adithya", coHead: "Mihirkanth" },
  { id: 14, name: "Website", imageSrc: "/images/final website photos/website.jpg", head: "Sadhvik", coHead: "Ritesh" },
  { id: 15, name: "Media Production", imageSrc: "/images/final website photos/Media Production.jpeg", head: "Koushik", coHead: "Vasisht" },
  { id: 16, name: "Documentation", imageSrc: "/images/final website photos/Documenttion.jpeg", head: "Shashank", coHead: "MG Preethi" },
  { id: 17, name: "Discipline Committee", imageSrc: "/images/final website photos/Discipline Commitee.jpeg", head: "Roop Sai Karthik", coHead: "Revanth Settipalli" },
  { id: 18, name: "Stalls", imageSrc: "/images/final website photos/stalls.jpeg", head: "Dinesh", },
  { id: 19, name: "HackSRM", imageSrc: "/images/final website photos/HackSRM.jpeg", head: "Nitish Sriram", coHead: "Bhowmik" },
];
