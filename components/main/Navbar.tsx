        ...
        {links.map(({ id, name, link, target }) => (
          <React.Fragment key={id}>
            {link === '/register' ? (
              <li>
                <Link href={link}>
                  <button className="group relative px-6 py-3 rounded-2xl backdrop-blur-md border-2 border-indigo-400/60 bg-gradient-to-br from-indigo-600/70 via-purple-700/60 to-indigo-800/70 shadow-[0_0_20px_rgba(99,102,241,0.3)] hover:shadow-[0_0_30px_rgba(99,102,241,0.5)] hover:scale-[1.02] hover:-translate-y-1 active:scale-95 transition-all duration-500 ease-out cursor-pointer hover:border-indigo-300/80 overflow-hidden">
                    ...
                    <div className="relative z-10 flex items-center justify-center">
                      <p className="text-white font-bold text-lg group-hover:text-gray-100 transition-colors duration-300 drop-shadow-lg uppercase font-red-rose">
                        Register
                      </p>
                    </div>
                  </button>
